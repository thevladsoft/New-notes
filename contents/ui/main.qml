...
PlasmoidItem {
    ...
    readonly property color textIconColor: {
       // if (Plasmoid.configuration.color === "black" || Plasmoid.configuration.color === "translucent-light") {
        if (!Plasmoid.configuration.darkfont){
            return "#dfdfdf";
        }
        return "#202020";
    }
        ...
        FocusScope {
            ...
            PlasmaComponents3.ScrollView {
                ...
                PlasmaComponents3.TextArea {
                    ...
                    property double cfgSlider: Plasmoid.configuration.slider
                    ...
                    background: Rectangle {
                        id:backy1
                        visible:true//Plasmoid.configuration.color === "translucent"||Plasmoid.configuration.color === "translucent-light"?false:true
                        radius:20                        
                        anchors {
                        top: parent.top
                        left: parent.left
                    ...
                    onCfgSliderChanged: {
                        if (activeFocus){backy1.opacity = 1.0}else{backy1.opacity = Plasmoid.configuration.slider}
                    }
            ...
            RowLayout {
                ...
                height: implicitHeight//visible ? implicitHeight : 0
                visible: opacity > 0
    ...
    Plasmoid.contextualActions: [
        ...
        PlasmaCore.Action {
            text: i18nc("@item:inmenu", "Dark fonts")
            onTriggered: Plasmoid.configuration.darkfont = true
        },
        PlasmaCore.Action {
            text: i18nc("@item:inmenu", "Light fonts")
            onTriggered: Plasmoid.configuration.darkfont= false
        },
        PlasmaCore.Action {
            isSeparator: true
        }
